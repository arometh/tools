package sn.arometh.notification.odoo.models;
/**
...
import sn.arometh.notification.odoo.*;
...
public class ProductUOM {
	 ...
	 *            UoM Factor Type
	 */
	public ProductUOM(Integer i, String n, Integer c, String cN, Double f, Double fi, String t) {
		id = i;
		name = n;
		category_id = c;
		category_id_NAME = cN;
	 ...
	 *            ID to load
	 */
	public ProductUOM(Odoo openerp, Integer uom_id) {
		OdooRecordSet rs = openerp.readRecords("product.uom", new Object[] { uom_id }, new String[] { "id", "name", "category_id", "factor", "factor_inv",
				"uom_type" });
		OdooRecord r = rs.get(uom_id);
		setProductUOM(r);
	}
	 ...
	 */
	public ProductUOM(OdooRecord r) {
		setProductUOM(r);
	}
	 ...
	 */
	public void setProductUOM(OdooRecord r) {
		id = (Integer) r.get("id");
	 ...
	 */
	public Double convert(Double value, ProductUOM uom_to) throws Exception {
		if (value == null)
			return null;
		if (uom_to == null)
			return null;
	 ...
	 */
	public boolean equals(ProductUOM compare) {
		if (compare == null)
			return false;
	 ...
	 */
	public boolean compatible(ProductUOM compare) {
		if (compare == null)
			return false;
